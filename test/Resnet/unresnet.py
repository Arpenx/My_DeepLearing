...
def main():
    orig_data = load_dataset('/Users/arpenx/Downloads/resnet50_dataset/')
    ...
    with tf.Session() as sess:
        ...
        for i in range(1000):
            ...
            _, loss_sess, accuracy_sess = sess.run([train_op, loss, accuracy_op],
                                                   feed_dict={features: x_to_feed, labels: y_to_feed})
